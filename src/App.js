          ...
          <div className="bg-gray-100 relative w-[80vw]  h-[70vh] mx-auto my-[9%] bg-opacity-70 rounded-lg ">
            ...
            <div className="flex justify-center gap-20 2xl:my-8 xl:my-8 lg:my-0  ">
              ...
              <div
                ...
                className="bg-[#fcfcfc]  md:overflow-hidden sm:overflow-hidden p-3 shadow-xl lg:w-[40vw] lg:p-0 lg:h-[25vh] sm:h-[25vh] sm:mt-0 rounded-xl w-[40%] 2xl:mt-9 xl:mt-7"
              >
                ...
                <p className="2xl:p-5 xl:p-5 lg:p-2 leading-1 2xl:opacity-100 xl:opacity-100 2xl:text-sm xl:text-sm lg:text-xs">
              ...
              >
                ...
                <SwiperSlide>
                  <div className="flex relative mx-[25%] gap-2 flex-col xl:w-[120px] lg:w-[100px] items-center justify-center">
                    ...
                    <span className="text-lg leading-loose whitespace-nowrap">ant design</span>
                    <div className="absolute left-[-40px] top-0 w-[200px] h-full bg-black bg-opacity-70 text-white opacity-0 hover:opacity-100 hover:border-black hover:rounded-3xl">
                      <h2 className="my-2 text-xl text-center whitespace-nowrap">
                        ant design
                      </h2>{" "}
          ...
          <div className="bg-gray-100 w-[80vw] relative h-[70vh] mx-auto my-[9%] 2xl:overflow-hidden xl:overflow-hidden md:overflow-y-scroll sm:overflow-y-scroll bg-opacity-80 rounded-lg flex ">
            <div className="flex gap-5 
             absolute left-[50%] translate-x-[-50%] my-7 ">
              ...
              <button
                className={`text-3xl font-semibold rounded-3xl text-black p-2  ${filtered === "team project" && "bg-pink-300 border-pink-300 border-2 text-white"
                  }`}
        ...
        <SwiperSlide>
          ...
          <div className="bg-gray-100 w-[80vw] relative h-[70vh] mx-auto my-[9%] bg-opacity-80 rounded-lg flex ">
            ...
            {filtered === "clone" && (
              <div className=" mx-auto font-gw my-[120px]">
                <div className="flex  my-2 ">
                  <div className=" w-[21vw] mx-4 h-[20vh] relative rounded-xl ">
                    <img
                      className="rounded-xl h-full"
                      src="/videos/stx.gif"
                      alt="stx"
                    ...
                    <div className="flex absolute top-[-30px] left-[50%] translate-x-[-50%] justify-center gap-4 text-xs items-center text-white">
                      <button
                        onClick={() =>
                          window.open(
                            "https://sirri1222.github.io/stx-clone/",
                        ...
                        className="px-1 py-1 bg-black rounded-3xl"
                      >
                        work
                      </button>
                      <button
                        ...
                        className="px-1 px-1 py-1 bg-black rounded-3xl"
                      >
                        github
                      </button>
                      <button
                  ...
                  <div className="relative w-[21vw] mx-4 h-[20vh] rounded-xl ">
                    <img
                      className="rounded-xl h-full"
                      src="/videos/hansalim.gif"
                      alt="stx"
                ...
                <div className="flex my-7">
                  <div className="relative w-[21vw] mt-7  mx-4 h-[20vh] rounded-xl ">
                    <img
                      className="rounded-xl h-full"
                      src="/videos/hyundai.gif"
                      alt="stx"
                  ...
                  <div className="relative w-[21vw] mt-7  mx-4 h-[20vh] ">
                    <img
                      className="rounded-xl h-full"
                      src="/videos/wonderplace.gif"
                      alt="stx"
